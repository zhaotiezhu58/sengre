/*
 ...
 Source Host           : sport-prod.crx8b9vznuyu.ap-east-1.rds.amazonaws.com:25794
 Source Schema         : nacos
...
) ENGINE = InnoDB AUTO_INCREMENT = 939 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = 'config_info' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 756 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('nacos', '$2a$10$fvjWgZqik.IytCvM0lDBEOHzYtLL5lPRnqEtpHOpr2UELZoozSqyq', 1);
